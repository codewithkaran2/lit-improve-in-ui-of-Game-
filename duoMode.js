...
function drawPowerUps() {
  powerUps.forEach((p) => {
    ...
    ctx.fillStyle = "white";
    ctx.font = "18px Arial";  // Larger font for better readability
...
function drawTopStatus() {
  ...
  // Shield bar for Player 1 with percentage display, renamed to 🛡️Shield:
  drawBar(leftX, shieldBarY, barWidth, barHeight, player1.shield, [
    { offset: 0, color: "#66ccff" },
    { offset: 1, color: "#0066cc" }
  ]);
  ctx.fillStyle = "white";
  ctx.fillText("🛡️Shield: " + player1.shield + "%", leftX + barWidth / 2, shieldBarY + barHeight / 2);
  ...
  // Shield bar for Player 2 with percentage display, renamed to 🛡️Shield:
  drawBar(rightX, shieldBarY2, barWidth, barHeight, player2.shield, [
    { offset: 0, color: "#66ccff" },
    { offset: 1, color: "#0066cc" }
  ]);
  ctx.fillStyle = "white";
  ctx.fillText("🛡️Shield: " + player2.shield + "%", rightX + barWidth / 2, shieldBarY2 + barHeight / 2);
